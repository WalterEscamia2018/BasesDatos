...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingrese la opcion 1 para agregar un cliente");

        jLabel3.setText("Ingrese la opcion 2 para agregar una factura a un cliente");

        jLabel4.setText("Ingrese la opcion 3 para ver los clientes registrados");

        jLabel5.setText("Ingrese la opcion 4 para ver las facturas de un cliente");

        jLabel7.setText("Ingrese la opcion 0 para terminar");

        cboOpciones.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "0", "1", "2", "3", "4" }));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cboOpciones, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(txtRespuesta, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void cboOpcionesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboOpcionesActionPerformed
        if ( cboOpciones.getSelectedItem().toString() == "1" )
        {
            txtRespuesta.setText("Ingrese el nombre del cliente");
